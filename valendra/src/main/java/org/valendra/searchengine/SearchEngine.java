 ...
 *
 * This class is responsible for taking the parsed user input and passing it into the database
 * handler to receive a list of related documents.
 *
...
public class SearchEngine extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    if (AccountsLogin.LOGGED_IN.equals("false")) {
      ...
      ScoreDoc[] hits =
          Arrays.copyOf(docs1.scoreDocs, docs1.scoreDocs.length + docs2.scoreDocs.length);
      ...
      for (int i = 0; i < hits.length; ++i) {
        ...
        out.println(
            "<a href=\"result?document=" + d.get("name") + "\">" + d.get("name") + "</a><br />");
      }
      out.println("</div>");
      out.println("</body>");
      out.println("</html>");
